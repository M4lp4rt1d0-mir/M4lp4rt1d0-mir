...
## 🛠️ Tecnologias e Habilidades
 Desenvolvimento Front-End: Experiência com interfaces modernas em JavaScript (ES6+) e Vue.JS, com foco em SPAs responsivas.<br>Engenharia de Dados: Especialista em extração e tratamento de grandes volumes de dados com Python (Pandas, NumPy). Agilidade: <br>Gestão de squad como Scrum Master, facilitando ritos de Scrum e Kanban. Ferramentas: Domínio de Jira, Azure DevOps, Confluence e ServiceNow. 
...
| :--- | :--- | :--- |
| [**Comércio eletrônico S**](https://github.com/M4lp4rt1d0-mir/E-commerce_S.git) | Plataforma de e-commerce com foco em experiência do usuário. | JavaScript / Vue.js |
| [**Projeto GTA**](https://github.com/M4lp4rt1d0-mir/Projeto-GTA.git) | Landing page temática com foco em interatividade e design moderno. | HTML / CSS / JS |
| [**Pássaro Flappy**](https://github.com/M4lp4rt1d0-mir/Projeto-FlappyBird.git) | Desenvolvimento de jogo e lógica de colisão. | Python / Desenvolvimento de jogos |
| [**Comércio eletrônico Thamiris**](https://github.com/M4lp4rt1d0-mir/E-commerce_thamiris.git) | Implementação de interface moderna para loja virtual. | Front-end |
...
## 📫 Vamos nos conectar?
- **LinkedIn:** [in/sbrenno-scrum-master](https://linkedin.com/in/sbrenno-scrum-master/)
...
---
*“Transformando dados em decisões e sprints em resultados.”*
